"""
This class is used to mainly test the prompting functionality of the GPTopic package. 
"""
...
from gptopic.Clustering import Clustering_and_DimRed
from gptopic.TopwordEnhancement import TopwordEnhancement
from gptopic.TopicPrompting import TopicPrompting


openai.organization = os.environ.get('OPENAI_ORG')

class TestGPTopic_prompting(unittest.TestCase):
    """
    This class is used to mainly test the prompting functionality of the GPTopic class.
    """
    ...
    def setUp(self):
        ...
        try:
            with open("Data/SavedTopicRepresentations/GPTopic_20ng.pkl", "rb")  as f:
                self.GPTopic = pickle.load(f)
        except FileNotFoundError:
              with open("../../Data/SavedTopicRepresentations/GPTopic_20ng.pkl", "rb")  as f:
                self.GPTopic = pickle.load(f)

        print(f"The topic list of this object is: \n {self.GPTopic.topic_lis} \n\n")

    def test_visualize_clusters(self):
        """
        test the visualize_clusters function of the GPTopic class
        """
        print("Testing visualize_clusters...")
        self.GPTopic.visualize_clusters()

    def test_repr_topics(self):
        """
        test the repr_topics function of the GPTopic class
        """
        print("Testing repr_topics...")
        self.assertTrue(type(self.GPTopic.repr_topics()) == str)
    ...
    def test_promt_knn_search(self):
        ...
        for prompt in prompt_lis:
            ...
            answer, function_result = self.GPTopic.prompt(prompt)
    ...
    def test_prompt_identify_topc_idx_no_index_prompt(self):
        ...
        answer, function_result = self.GPTopic.prompt(no_index_prompt)
    ...
    def test_prompt_split_topic_kmeans(self):
        ...
        for prompt, added_topic_len in zip(prompt_lis, added_topic_lis_len):
                ...
                self.assertTrue(len(function_result) == added_topic_len + len(self.GPTopic.topic_lis) -1 )
    ...
    def test_prompt_split_topic_kmeans_inplace(self):
        ...
        old_number_of_topics = len(self.GPTopic.topic_lis)
        ...
        for prompt, added_topic_len in zip(prompt_lis, added_topic_lis_len):
                ...
                self.assertTrue(len(self.GPTopic.topic_lis) == old_number_of_topics + added_topic_len -1 )
                self.assertTrue(self.GPTopic.topic_lis == function_result)
    ...
    def test_prompt_split_topic_hdbscan_inplace(self):
        ...
        for prompt in prompt_lis:
                ...
                print("topic_gpt_topic_list: ", self.GPTopic.topic_lis)
                print("function_result: ", function_result)
                self.assertTrue(self.GPTopic.topic_lis == function_result)
    ...
    def test_prompt_combine_topics(self):
        ...
        for prompt in prompt_lis:
                ...
                self.assertTrue(type(function_result) == list)
                self.assertTrue(type(function_result[0]) == Topic)
                self.assertTrue(len(function_result) == len(self.GPTopic.topic_lis) -1)
    ...
    def test_prompt_combine_topics_inplace(self):
        ...
        old_number_topics = len(self.GPTopic.topic_lis)
        ...
        for prompt in prompt_lis:
                ...
                self.assertTrue(type(function_result[0]) == Topic)
                self.assertTrue(self.GPTopic.topic_lis == function_result)
                self.assertTrue(len(self.GPTopic.topic_lis) == old_number_topics -1)
    ...
    def test_prompt_get_topic_information(self):
         """
         test the get_topic_information function of the GPTopic class
         """
