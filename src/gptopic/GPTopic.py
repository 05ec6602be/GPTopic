...
try:
    ...
    from gptopic.ExtractTopWords import ExtractTopWords
    from gptopic.TopwordEnhancement import TopwordEnhancement
    from gptopic.GetEmbeddingsOpenAI import GetEmbeddingsOpenAI
    from gptopic.TopicPrompting import TopicPrompting
    from gptopic.TopicRepresentation import Topic
    import gptopic.TopicRepresentation as TopicRepresentation
except:
...
class GPTopic:
    """
    This is the main class for doing topic modelling with GPTopic. 
    """
    ...
    def __init__(self,
        ...
        """
        Initializes the main class for conducting topic modeling with GPTopic.
    ...
    def __repr__(self) -> str:
        repr = "GPTopic object with the following parameters:\n"
        repr += "-"*150 + "\n"
