...
try: 
    ...
    from gptopic.TopicRepresentation import extract_and_describe_topic_cos_sim
    from gptopic.TopicRepresentation import extract_describe_topics_labels_vocab
